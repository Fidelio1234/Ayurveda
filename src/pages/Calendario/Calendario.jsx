...
const handleLogout = () => {
  ...
  /*const handleCreaPrenotazione = async (formData) => {
    try {
      console.log('🚀 INIZIO SALVATAGGIO PRENOTAZIONE');
      console.log('📋 Dati dal form:', formData);
      
      // USA SOLO LA DATA, SENZA TIMESTAMP!
      const dataPerDatabase = formData.data_prenotazione; // "2025-11-26"
      ...
      const datiPerDatabase = {
        ...
        data_prenotazione: dataPerDatabase, // Solo la data, senza ore
        ora_inizio: formData.ora_inizio,
        ora_fine: formData.ora_fine,
        note: formData.note || null
      };

      console.log('📤 Dati per Supabase:', datiPerDatabase);
      ...
      console.log('✅ SUCCESSO - Prenotazione salvata');
      await caricaDati();
      console.log('📊 Dati restituiti:', data[0]);
      console.log('🎯 Data salvata nel DB:', data[0]?.data_prenotazione);
